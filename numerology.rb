...
# 3. use array syntax to access each element in the birthdate and add them all together
...
# 2. use gets to assign birthdate
birthdate = gets

birth_path_num = get_birth_path_number(birthdate)
